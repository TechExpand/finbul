      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: FutureBuilder(
                future: network.getStockDetail(widget.data.symbol),
                                  ...
                                  child: Center(
                                    child: Row(
                                      children: [
                                        ...
                                        // ),
                                        StreamBuilder(
                                            stream: FirebaseApi.watchListStream(
                                            ...
                                            builder: (context,
                                              ...
                                              if (snapshotstream.hasData) {
                                                ...
                                                watchlist = snapshotstream
                                                    .data.docs
                                                    .map((doc) =>
                                                        WatchListModel.fromMap(
                                                            doc.data(), doc.id))
                                                    .toList();

                                                switch (snapshotstream
                                                    .connectionState) {
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          '(△ ${snapshot.data['changesPercentage']}%)',
                                          style: TextStyle(
                                              color: snapshot
                                                            ...
                                                            children: [
                                                              ...
                                                              Container(
                                                                ...
                                                                child: Text(
                                                                  ...
                                                                  style: TextStyle(
                                                                      color: ((bearish.length / verifiedPostsComment.length) * 100).ceil() <=
                                                                              ((bullish.length / verifiedPostsComment.length) * 100)
                                                                                  .ceil()
                                                                          ? Colors
                                                                              .red
                                                                          : Color(
                                                              ...
                                                              Container(
                                                                ...
                                                                child: Padding(
                                                                  padding: const EdgeInsets
                                                                      ...
                                                                      right: 6),
                                                                  child: Text(
                                                                      "${((bearish.length / verifiedPostsComment.length) * 100).ceil() <= ((bullish.length / verifiedPostsComment.length) * 100).ceil() ? '-${((bearish.length / verifiedPostsComment.length) * 100).ceil()}%' : '+${((bullish.length / verifiedPostsComment.length) * 100).ceil()}%'}",
                                                                      style:
                                                                          TextStyle(
                                                                        color: ((bearish.length / verifiedPostsComment.length) * 100).ceil() <=
                                                                                ((bullish.length / verifiedPostsComment.length) * 100).ceil()
                                                                            ? Colors.red
                                                                            : Color(0xFF26D375),
                                                                        fontWeight:
                                                                            FontWeight.bold,
