...
class WebServices extends ChangeNotifier {
  ...
  Future<dynamic> search(word) async {
    var response = await http.get(
        Uri.parse('https://api.twelvedata.com/symbol_search?symbol=$word&&apikey=38afea301d2f4e328cde9f8287c1ebc1'),
        headers: {
          "Content-type": "application/x-www-form-urlencoded",
          //  'Authorization': 'Bearer $bearer',
        });
  ...
  Future<dynamic> getCoinsTimeSeries(String filter,String symbol) async {
      var response = await http.get(
          Uri.parse(
              'https://api.twelvedata.com/time_series?symbol=$symbol&interval=$filter&outputsize=30&apikey=38afea301d2f4e328cde9f8287c1ebc1'),
          headers: {
            "Content-type": "application/x-www-form-urlencoded",
            //  'Authorization': 'Bearer $bearer',
          });
