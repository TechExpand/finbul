...
class Details2 extends StatefulWidget {
  ...
  @override
  Details2State createState() => Details2State();
}

class Details2State extends State<Details2>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                                        ...
                                        if (verifiedwatchlist
                                          ...
                                          return Container(
                                            child: FlatButton(
                                              onPressed: () {
                                                print('hhhhhhh');
                                                FirebaseApi.uploadWatchList(id: provide.firebaseUserId, symbol: widget.data.symbol);
                                              },
                                              color: Color(
                                                  0xFFFEB904),
                                          ...
                                          if(watch.contains(widget.data.symbol)){
                                            return Container(
                                              child: FlatButton(
                                                onPressed: null,
                                                color: Color(
                    ...
                    child: Row(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            '(△ ${widget.data.percent_change}%)',
                            style: TextStyle(
                                color: widget.data.percent_change
                                .toString().contains('-')
                                ? Colors.red
                                : Color(0xFF26D375),
                                fontWeight: FontWeight.bold),
                            ...
                            itemBuilder: (context, index) {
                              return InkWell(
                                onTap: () {
                                  ...
                                  ItemDetailsPage(
                                      symbol: widget.data.symbol.toString(),
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  ...
                                                  child: Padding(
                                                    padding: const EdgeInsets.only(
                                                        top: 2.0, bottom: 2, left: 6, right: 6),
                                                    child: Text('${widget.data.average_volume}',
                                                        style: TextStyle(
                  ...
                  Container(
                    ...
                    child: TabBarView(
                      ...
                      children: [
                        StreamBuilder(
                          stream:
                              FirebaseApi.profileStream(provide.firebaseUserId),
                          builder:
                            ...
                            if (snapshot.hasData) {
                              ...
                              profiles = snapshot.data.docs
                                  .map((doc) =>
                                      Profile.fromMap(doc.data(), doc.id))
                                  .toList();
     ...
     valueColor: new AlwaysStoppedAnimation<Color>(Colors.white10),
                        ...
                        FutureBuilder(
                            future: network.getStockNews(widget.data.symbol),
